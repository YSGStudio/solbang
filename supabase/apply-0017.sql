-- apply-0016.sql 까지 실행한 프로젝트에 이 파일만 추가로 Run 하세요.
-- Supabase 대시보드 > SQL Editor 에 통째로 붙여넣고 Run.
--
-- 번개모임에 만나는 날짜·시간(meet_at)을 추가합니다. 번개모임은 필수,
-- 소모임은 가질 수 없습니다. 목록 위 달력이 이 값을 읽습니다.
--
-- ⚠ 이미 올라온 번개모임 1건("9월 1일 오전 7시 노량진 맥모닝 드실 분")은
--   제목에 적힌 시각을 2026-09-01 07:00 로 옮깁니다. 제 추정이므로 글쓴이가
--   수정 화면에서 확인해 주세요.

-- apply-0014.sql 까지 실행한 프로젝트에 이 파일만 추가로 Run 하세요.
-- Supabase 대시보드 > SQL Editor 에 통째로 붙여넣고 Run.
--
-- 중등 + 수업교구 + 교과목을 고른 뒤 단원 1개와 성취기준 여러 개를 고를 수
-- 있게 합니다. 고른 결과(unit, standards)만 저장하고, 성취기준 목록 자체는
-- 데이터베이스가 아니라 src/lib/curriculum/secondaryInformatics.ts 에 있습니다.
--
-- 과목 목록에 '정보' 를 추가합니다(이 기능의 대상 교과인데 빠져 있었음).

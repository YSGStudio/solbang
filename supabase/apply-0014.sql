-- apply-0013.sql 까지 실행한 프로젝트에 이 파일만 추가로 Run 하세요.
-- Supabase 대시보드 > SQL Editor 에 통째로 붙여넣고 Run.
--
-- 나눔 분류 체계 개편
--   학교급   초등 / 중등                       (라디오)
--   카테고리 학급경영 / 수업교구 / 교사용품     (라디오, '학급자료' 없어짐)
--   세부     초등+수업교구 -> 학년군 1-2 / 3-4 / 5-6
--            중등+수업교구 -> 교과목
--            학급경영·교사용품 -> 없음
--   품목유형 카테고리별 목록 (21종 신규, 기존 8종은 비활성)
--
-- 탄소 계수는 새로 지어내지 않고 기존 8종(재질·무게 기반) 값을 물려받습니다.
-- 이미 올라간 글의 절감량은 마이그레이션 9가 동결하므로 바뀌지 않습니다.
